...
public OnPlayerConnect(playerid)
{
    ...
    else if (SvHasMicro(playerid) == SV_FALSE)
    {
		...
		Dialog_Show(playerid, "DialogNotUsed", DIALOG_STYLE_MSGBOX, "WARGANET "WHITE"- Mic Tidak Terdeteksi", lstring, "Quit", "");
...
public OnFilterScriptInit()
{
    ...
    print("-------------------- [WARGANET Voice Chat System] --------------------\n\
    ===>> Berhasil dimuat dengan baik!\n\
    ===>> by: Shan (Muhammad Ikhsan)\n\
    ===>> dipersembahkan untuk WARGANET\n\
    -------------------------------------------------------------------");
    return 1;
}
