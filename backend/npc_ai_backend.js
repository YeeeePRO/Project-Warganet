...
app.post('/api/npc/chat', async (req, res) => {
    try {
        ...
        const systemPrompt = `Kamu adalah WARGANET Guardian, AI petugas bandara di ${SERVER_INFO.city}, server ${SERVER_INFO.name}.

        === IDENTITAS KAMU ===
        - Nama: WARGANET Guardian
